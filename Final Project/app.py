...
def index():
	if request.method == 'POST':
		...
		####ONSET OF SEARCH.PY
		url = "https://inf551-89468.firebaseio.com/"+db+"/"
	...
	return render_template("index.html", data=['World', 'Movie', 'Business'])
...
def explore(col_name, fkey, table, db_name, sq_name):
	...
	data.remove(db_name.capitalize())
	data.insert(0, db_name.capitalize())
...
def retrieve_next(col_name, fk, table, db_name):
	...
	url = "https://inf551-89468.firebaseio.com/"+db_name+"/"
